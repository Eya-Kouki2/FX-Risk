    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Seuils de risque et configuration des alertes
        </p>
      </div>
      ...
      <section className="stat-card space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <Label>Seuil de montant élevé (EUR)</Label>
            <Input type="number" defaultValue={1000000} />
          </div>
          <div className="space-y-1.5">
            <Label>Tolérance de déviation du taux (%)</Label>
      ...
      <section className="stat-card space-y-4">
        ...
        {[
          ...
          {
            k: "Notifications dans l'application",
            d: "Afficher les notifications dans le tableau de bord",
          },
          {
            k: "Escalade automatique critique",
            d: "Escalader les opérations critiques vers la file du responsable",
          },
        ].map((s) => (
          <div
            key={s.k}
            className="flex items-center justify-between gap-4 py-2 border-t border-border first:border-0"
          >
            <div>
